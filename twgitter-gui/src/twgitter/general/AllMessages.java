...
public class AllMessages {
	...
	public List<AllHashtag> getHashtag() {
		return hashtag;
	}


	public List<AllLink> getLink() {
		return link;
	}


	public List<AllMention> getMention() {
		return mention;
	}


	public AllMessages getSpread() {
		return spread;
	}
	...
	public int getNum_spread() {
		return num_spread;
	}


	public boolean isYou_reposted() {
		return you_reposted;
	}


	public boolean isYou_starred() {
		return you_starred;
	}


	public boolean isYou_spreaded() {
		return you_spreaded;
	}
	...
	public boolean isMachine_only() {
		return machine_only;
	}


	public int getPagination_id() {
	...
	public String getNew_user_nickname() {
	...
	public void setEdited_by(AllUser edited_by) {
	...
	public void setHashtag(List<AllHashtag> hashtag) {
		this.hashtag = hashtag;
	}


	public void setLink(List<AllLink> link) {
		this.link = link;
	}


	public void setMention(List<AllMention> mention) {
		this.mention = mention;
	}


	public void setSpread(AllMessages spread) {
		this.spread = spread;
	}
	...
	public void setNum_spread(int num_spread) {
		this.num_spread = num_spread;
	}


	public void setYou_reposted(boolean you_reposted) {
		this.you_reposted = you_reposted;
	}


	public void setYou_starred(boolean you_starred) {
		this.you_starred = you_starred;
	}


	public void setYou_spreaded(boolean you_spreaded) {
		this.you_spreaded = you_spreaded;
	}
	...
	public void setPagination_id(int pagination_id) {
	...
	public void setChan_topic(String chan_topic) {
		this.chan_topic = chan_topic;
	}
	...
	public void setNew_user_nickname(String new_user_nickname) {
		this.new_user_nickname = new_user_nickname;
	}
